...
No. Free users get 100 requests per day via LinguaVox's shared OpenAI key pool — no OpenAI account needed. If you need unlimited usage, add your own OpenAI API key in the [dashboard](https://linguavox-landing.pages.dev/dashboard/apikey).
...
100 transcription/translation requests per day. No credit card. No OpenAI account needed. Resets every 24 hours.
